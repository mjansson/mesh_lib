...
main_initialize(void) {
	...
	application.name = string_const(STRING_CONST("Mesh library test suite"));
	...
	return mesh_module_initialize(mesh_config);
}
...
main_run(void* main_arg) {
	...
	log_infof(HASH_TEST, STRING_CONST("Mesh library v%s built for %s using %s (%s)"),
	          string_from_version_static(mesh_module_version()).str,
